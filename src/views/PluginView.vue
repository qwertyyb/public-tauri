...
onMounted(() => {
  ...
  innerBridge.handle('getPreferenceValues', (commandName?: string) => window.publicApp.plugin.getPreferenceValues(props.plugin.manifest.name, commandName));
  innerBridge.handle('openPreferences', (commandName?: string) => window.publicApp.plugin.openPreferences(props.plugin.manifest.name, commandName));
