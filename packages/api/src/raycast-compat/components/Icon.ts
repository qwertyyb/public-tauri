/**
 * Raycast {@link Icon} 兼容：成员名与 @raycast/api 一致，取值为可直接交给 @public-tauri/icon 的
 * `public-icon://builtin/<Material 名>` 协议串。
 *
 * 更新时请对照 @raycast/api Icon 重新跑生成脚本（见仓库内用于生成本文件的脚本/说明）。
 */
export enum Icon {
